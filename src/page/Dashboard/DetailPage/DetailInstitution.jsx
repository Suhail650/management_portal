...
const DetailInstitution = () => {
  ...
  const { loading, institution, error } = useSelector((state) => state.institution);
  ...
  if (loading) {
    return <div className='m-5 text-center'>Loading Institutions. Please wait...</div>;
  }
  if (error) {
    ...
    <div className='container'>
      ...
      <div className='m-5'>
        ...
        <div className='d-flex flex-wrap gap-2 m-3'>
          {!isEditing ? (
            <button className='btn btn-outline-danger btn-sm w-100 w-md-auto' onClick={handleEdit}>
              <FaEdit className='me-2' /> Edit
            </button>
          ) : (
            <button className='btn btn-outline-warning btn-sm w-100 w-md-auto' onClick={handleSave}>
